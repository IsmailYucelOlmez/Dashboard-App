  ...
  return (
    ...
    {!settings ? (
      <nav className='flex flex-col items-center gap-4 mt-10'>
        ...
        <NavLink to={"/line-graphic"} className={({ isActive }) => `py-1 w-3/4 text-center rounded-xl flex items-center justify-center gap-3 ${isActive ? `text-xl font-semibold text-white bg-[${themeColor}] ` : 'text-lg hover:bg-slate-200'}`} > <i className="fa-solid fa-chart-line"></i> Line</NavLink>
        <NavLink to={"/pie-graphic"} className={({ isActive }) => `py-1 w-3/4 text-center rounded-xl flex items-center justify-center gap-3 ${isActive ? `text-xl font-semibold text-white bg-[${themeColor}] ` : 'text-lg hover:bg-slate-200'}`} > <i className="fa-solid fa-chart-pie"></i> Pie</NavLink>
        <NavLink to={"/bar-graphic"}className={({ isActive }) => `py-1 w-3/4 text-center rounded-xl flex items-center justify-center gap-3 ${isActive ? `text-xl font-semibold text-white bg-[${themeColor}] ` : 'text-lg hover:bg-slate-200'}`} > <i className="fa-solid fa-chart-column"></i> Bar</NavLink>
